千古前端：超详细的前端入门到进阶学习笔记。从零开始学前端 [地址](https://github.com/qianguyihao/Web)

TypeScript入门教程 [地址](https://github.com/xcatliu/typescript-tutorial)

50projects50days：50 个采用 HTML+CSS+JS 的前端小项目集合。标准入门级的前端开源项目  [地址](https://github.com/bradtraversy/50projects50days)
